 ...
 */
public class Mima2JPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (p1.length() == 0 || p2.length() == 0 || p3.length() == 0) {
            ...
            try {
                ...
                PreparedStatement pp = con.prepareStatement("select * from susers where id=? and password=?");
                pp.setInt(1, id);
                pp.setString(2, jPasswordField1.getText().trim());
                ResultSet rs = pp.executeQuery();
                if (rs.next()) {
                    String sql = "update susers set password=? where id = " + id + "";
